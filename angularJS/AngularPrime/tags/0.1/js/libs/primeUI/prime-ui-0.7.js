    ...
    $.widget("primeui.puirating", {
        ...
        _bindEvents: function() {
            ...
            this.stars.click(function() {
                ...
                $this.setValue(value); // Rubus Changed for Angular JS
            });
        ...
        cancel: function() {
            ...
            this._trigger('rate', null, 0); // Rubus Changed for Angular JS
        },
        ...
        setValue: function(value) { // Rubus Changed for Angular JS
